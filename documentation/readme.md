...
- [1. Networks > items](#items)
  - [1.1. [Required] Property Networks > items > name](#items_name)
  - [1.2. [Optional] Property Networks > items > description](#items_description)
  - [1.3. [Optional] Property Networks > items > mtu](#items_mtu)
  - [1.4. [Optional] Property Networks > items > private_google_access](#items_private_google_access)
  - [1.5. [Optional] Property Networks > items > private_service_connection](#items_private_service_connection)
    - [1.5.1. Property `Networks > items > private_service_connection > oneOf > item 0`](#items_private_service_connection_oneOf_i0)
      - [1.5.1.1. [Optional] Property Networks > items > private_service_connection > oneOf > item 0 > export_custom_routes](#items_private_service_connection_oneOf_i0_export_custom_routes)
      - [1.5.1.2. [Optional] Property Networks > items > private_service_connection > oneOf > item 0 > import_custom_routes](#items_private_service_connection_oneOf_i0_import_custom_routes)
      - [1.5.1.3. [Required] Property Networks > items > private_service_connection > oneOf > item 0 > ip_cidr_range](#items_private_service_connection_oneOf_i0_ip_cidr_range)
    - [1.5.2. Property `Networks > items > private_service_connection > oneOf > item 1`](#items_private_service_connection_oneOf_i1)
      - [1.5.2.1. [Optional] Property Networks > items > private_service_connection > oneOf > item 1 > export_custom_routes](#items_private_service_connection_oneOf_i1_export_custom_routes)
      - [1.5.2.2. [Optional] Property Networks > items > private_service_connection > oneOf > item 1 > import_custom_routes](#items_private_service_connection_oneOf_i1_import_custom_routes)
      - [1.5.2.3. [Required] Property Networks > items > private_service_connection > oneOf > item 1 > ip_cidr_prefix](#items_private_service_connection_oneOf_i1_ip_cidr_prefix)
  - [1.6. [Optional] Property Networks > items > routing_mode](#items_routing_mode)
  - [1.7. [Optional] Property Networks > items > subnetworks](#items_subnetworks)
    - [1.7.1. Networks > items > subnetworks > Subnetwork](#items_subnetworks_items)
      - [1.7.1.1. Property `Networks > items > subnetworks > Subnetwork > allOf > Private`](#items_subnetworks_items_allOf_i0)
        - [1.7.1.1.1. If (purpose = "PRIVATE")](#autogenerated_heading_2)
          - [1.7.1.1.1.1. [Required] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > ip_cidr_range](#items_subnetworks_items_allOf_i0_then_ip_cidr_range)
          - [1.7.1.1.1.2. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > name](#items_subnetworks_items_allOf_i0_then_name)
          - [1.7.1.1.1.3. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > purpose](#items_subnetworks_items_allOf_i0_then_purpose)
          - [1.7.1.1.1.4. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > description](#items_subnetworks_items_allOf_i0_then_description)
          - [1.7.1.1.1.5. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > secondary_subnetworks](#items_subnetworks_items_allOf_i0_then_secondary_subnetworks)
            - [1.7.1.1.1.5.1. Networks > items > subnetworks > Subnetwork > allOf > Private > then > secondary_subnetworks > items](#items_subnetworks_items_allOf_i0_then_secondary_subnetworks_items)
              - [1.7.1.1.1.5.1.1. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > secondary_subnetworks > items > nat_group_id](#items_subnetworks_items_allOf_i0_then_secondary_subnetworks_items_nat_group_id)
              - [1.7.1.1.1.5.1.2. [Required] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > secondary_subnetworks > items > ip_cidr_range](#items_subnetworks_items_allOf_i0_then_secondary_subnetworks_items_ip_cidr_range)
          - [1.7.1.1.1.6. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > private_ip_google_access](#items_subnetworks_items_allOf_i0_then_private_ip_google_access)
          - [1.7.1.1.1.7. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > log_config](#items_subnetworks_items_allOf_i0_then_log_config)
            - [1.7.1.1.1.7.1. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > log_config > enabled](#items_subnetworks_items_allOf_i0_then_log_config_enabled)
            - [1.7.1.1.1.7.2. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > log_config > aggregation_interval](#items_subnetworks_items_allOf_i0_then_log_config_aggregation_interval)
            - [1.7.1.1.1.7.3. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > log_config > flow_sampling](#items_subnetworks_items_allOf_i0_then_log_config_flow_sampling)
            - [1.7.1.1.1.7.4. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > log_config > metadata](#items_subnetworks_items_allOf_i0_then_log_config_metadata)
            - [1.7.1.1.1.7.5. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > log_config > metadata_fields](#items_subnetworks_items_allOf_i0_then_log_config_metadata_fields)
              - [1.7.1.1.1.7.5.1. Networks > items > subnetworks > Subnetwork > allOf > Private > then > log_config > metadata_fields > items](#items_subnetworks_items_allOf_i0_then_log_config_metadata_fields_items)
          - [1.7.1.1.1.8. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > cloud_nat](#items_subnetworks_items_allOf_i0_then_cloud_nat)
            - [1.7.1.1.1.8.1. [Required] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > cloud_nat > subnetworks_to_nat](#items_subnetworks_items_allOf_i0_then_cloud_nat_subnetworks_to_nat)
            - [1.7.1.1.1.8.2. [Required] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > cloud_nat > nat_group_id](#items_subnetworks_items_allOf_i0_then_cloud_nat_nat_group_id)
          - [1.7.1.1.1.9. [Required] Property Networks > items > subnetworks > Subnetwork > allOf > Private > then > region](#items_subnetworks_items_allOf_i0_then_region)
      - [1.7.1.2. Property `Networks > items > subnetworks > Subnetwork > allOf > Private Service Connect`](#items_subnetworks_items_allOf_i1)
        - [1.7.1.2.1. If (purpose = "PRIVATE_SERVICE_CONNECT")](#autogenerated_heading_3)
          - [1.7.1.2.1.1. [Required] Property Networks > items > subnetworks > Subnetwork > allOf > Private Service Connect > then > ip_cidr_range](#items_subnetworks_items_allOf_i1_then_ip_cidr_range)
          - [1.7.1.2.1.2. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private Service Connect > then > name](#items_subnetworks_items_allOf_i1_then_name)
          - [1.7.1.2.1.3. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private Service Connect > then > purpose](#items_subnetworks_items_allOf_i1_then_purpose)
          - [1.7.1.2.1.4. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Private Service Connect > then > description](#items_subnetworks_items_allOf_i1_then_description)
          - [1.7.1.2.1.5. [Required] Property Networks > items > subnetworks > Subnetwork > allOf > Private Service Connect > then > region](#items_subnetworks_items_allOf_i1_then_region)
      - [1.7.1.3. Property `Networks > items > subnetworks > Subnetwork > allOf > Internal HTTP(s) Load Balancer`](#items_subnetworks_items_allOf_i2)
        - [1.7.1.3.1. If (purpose = "INTERNAL_HTTPS_LOAD_BALANCER")](#autogenerated_heading_4)
          - [1.7.1.3.1.1. [Required] Property Networks > items > subnetworks > Subnetwork > allOf > Internal HTTP(s) Load Balancer > then > ip_cidr_range](#items_subnetworks_items_allOf_i2_then_ip_cidr_range)
          - [1.7.1.3.1.2. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Internal HTTP(s) Load Balancer > then > name](#items_subnetworks_items_allOf_i2_then_name)
          - [1.7.1.3.1.3. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Internal HTTP(s) Load Balancer > then > purpose](#items_subnetworks_items_allOf_i2_then_purpose)
          - [1.7.1.3.1.4. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Internal HTTP(s) Load Balancer > then > description](#items_subnetworks_items_allOf_i2_then_description)
          - [1.7.1.3.1.5. [Required] Property Networks > items > subnetworks > Subnetwork > allOf > Internal HTTP(s) Load Balancer > then > region](#items_subnetworks_items_allOf_i2_then_region)
          - [1.7.1.3.1.6. [Optional] Property Networks > items > subnetworks > Subnetwork > allOf > Internal HTTP(s) Load Balancer > then > role](#items_subnetworks_items_allOf_i2_then_role)
  - [1.8. [Optional] Property Networks > items > cloud_nat](#items_cloud_nat)
    - [1.8.1. Property `Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks`](#items_cloud_nat_allOf_i0)
      - [1.8.1.1. If (subnetworks_to_nat = "ALL_PRIMARY_SUBNETWORKS_ALL_SECONDARY_SUBNETWORKS")](#autogenerated_heading_5)
        - [1.8.1.1.1. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > subnetworks_to_nat](#items_cloud_nat_allOf_i0_then_subnetworks_to_nat)
        - [1.8.1.1.2. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > log_config](#items_cloud_nat_allOf_i0_then_log_config)
        - [1.8.1.1.3. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > min_ports_per_vm](#items_cloud_nat_allOf_i0_then_min_ports_per_vm)
        - [1.8.1.1.4. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > udp_idle_timeout](#items_cloud_nat_allOf_i0_then_udp_idle_timeout)
        - [1.8.1.1.5. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > icmp_idle_timeout](#items_cloud_nat_allOf_i0_then_icmp_idle_timeout)
        - [1.8.1.1.6. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > tcp_established_idle_timeout](#items_cloud_nat_allOf_i0_then_tcp_established_idle_timeout)
        - [1.8.1.1.7. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > tcp_transitory_idle_timeout](#items_cloud_nat_allOf_i0_then_tcp_transitory_idle_timeout)
    - [1.8.2. Property `Networks > items > cloud_nat > allOf > All Primary Subnetworks`](#items_cloud_nat_allOf_i1)
      - [1.8.2.1. If (subnetworks_to_nat = "ALL_PRIMARY_SUBNETWORKS")](#autogenerated_heading_6)
        - [1.8.2.1.1. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > subnetworks_to_nat](#items_cloud_nat_allOf_i0_then_subnetworks_to_nat)
        - [1.8.2.1.2. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > log_config](#items_cloud_nat_allOf_i0_then_log_config)
        - [1.8.2.1.3. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > min_ports_per_vm](#items_cloud_nat_allOf_i0_then_min_ports_per_vm)
        - [1.8.2.1.4. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > udp_idle_timeout](#items_cloud_nat_allOf_i0_then_udp_idle_timeout)
        - [1.8.2.1.5. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > icmp_idle_timeout](#items_cloud_nat_allOf_i0_then_icmp_idle_timeout)
        - [1.8.2.1.6. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > tcp_established_idle_timeout](#items_cloud_nat_allOf_i0_then_tcp_established_idle_timeout)
        - [1.8.2.1.7. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > tcp_transitory_idle_timeout](#items_cloud_nat_allOf_i0_then_tcp_transitory_idle_timeout)
    - [1.8.3. Property `Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks`](#items_cloud_nat_allOf_i2)
      - [1.8.3.1. If (subnetworks_to_nat = "SELECTED_PRIMARY_SUBNETWORKS_SELECTED_SECONDARY_SUBNETWORKS")](#autogenerated_heading_7)
        - [1.8.3.1.1. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > subnetworks_to_nat](#items_cloud_nat_allOf_i2_then_subnetworks_to_nat)
        - [1.8.3.1.2. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups](#items_cloud_nat_allOf_i2_then_nat_groups)
          - [1.8.3.1.2.1. Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items](#items_cloud_nat_allOf_i2_then_nat_groups_items)
            - [1.8.3.1.2.1.1. [Required] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > nat_group_id](#items_cloud_nat_allOf_i2_then_nat_groups_items_nat_group_id)
            - [1.8.3.1.2.1.2. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > log_config](#items_cloud_nat_allOf_i2_then_nat_groups_items_log_config)
            - [1.8.3.1.2.1.3. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > min_ports_per_vm](#items_cloud_nat_allOf_i2_then_nat_groups_items_min_ports_per_vm)
            - [1.8.3.1.2.1.4. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > udp_idle_timeout](#items_cloud_nat_allOf_i2_then_nat_groups_items_udp_idle_timeout)
            - [1.8.3.1.2.1.5. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > icmp_idle_timeout](#items_cloud_nat_allOf_i2_then_nat_groups_items_icmp_idle_timeout)
            - [1.8.3.1.2.1.6. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > tcp_established_idle_timeout](#items_cloud_nat_allOf_i2_then_nat_groups_items_tcp_established_idle_timeout)
            - [1.8.3.1.2.1.7. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > tcp_transitory_idle_timeout](#items_cloud_nat_allOf_i2_then_nat_groups_items_tcp_transitory_idle_timeout)
    - [1.8.4. Property `Networks > items > cloud_nat > allOf > [DISABLED] All Primary and Secondary Sub`](#items_cloud_nat_allOf_i3)
      - [1.8.4.1. If (subnetworks_to_nat = "DISABLED")](#autogenerated_heading_8)
        - [1.8.4.1.1. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > subnetworks_to_nat](#items_cloud_nat_allOf_i0_then_subnetworks_to_nat)
        - [1.8.4.1.2. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > log_config](#items_cloud_nat_allOf_i0_then_log_config)
        - [1.8.4.1.3. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > min_ports_per_vm](#items_cloud_nat_allOf_i0_then_min_ports_per_vm)
        - [1.8.4.1.4. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > udp_idle_timeout](#items_cloud_nat_allOf_i0_then_udp_idle_timeout)
        - [1.8.4.1.5. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > icmp_idle_timeout](#items_cloud_nat_allOf_i0_then_icmp_idle_timeout)
        - [1.8.4.1.6. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > tcp_established_idle_timeout](#items_cloud_nat_allOf_i0_then_tcp_established_idle_timeout)
        - [1.8.4.1.7. [Optional] Property Networks > items > cloud_nat > allOf > All Primary and Secondary Subnetworks > then > tcp_transitory_idle_timeout](#items_cloud_nat_allOf_i0_then_tcp_transitory_idle_timeout)
    - [1.8.5. Property `Networks > items > cloud_nat > allOf > [DISABLED] Selected Primary Subnetworks and Selected Secondary Subnetworks`](#items_cloud_nat_allOf_i4)
      - [1.8.5.1. If (subnetworks_to_nat = "DISABLED")](#autogenerated_heading_9)
        - [1.8.5.1.1. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > subnetworks_to_nat](#items_cloud_nat_allOf_i2_then_subnetworks_to_nat)
        - [1.8.5.1.2. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups](#items_cloud_nat_allOf_i2_then_nat_groups)
          - [1.8.5.1.2.1. Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items](#items_cloud_nat_allOf_i2_then_nat_groups_items)
            - [1.8.5.1.2.1.1. [Required] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > nat_group_id](#items_cloud_nat_allOf_i2_then_nat_groups_items_nat_group_id)
            - [1.8.5.1.2.1.2. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > log_config](#items_cloud_nat_allOf_i2_then_nat_groups_items_log_config)
            - [1.8.5.1.2.1.3. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > min_ports_per_vm](#items_cloud_nat_allOf_i2_then_nat_groups_items_min_ports_per_vm)
            - [1.8.5.1.2.1.4. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > udp_idle_timeout](#items_cloud_nat_allOf_i2_then_nat_groups_items_udp_idle_timeout)
            - [1.8.5.1.2.1.5. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > icmp_idle_timeout](#items_cloud_nat_allOf_i2_then_nat_groups_items_icmp_idle_timeout)
            - [1.8.5.1.2.1.6. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > tcp_established_idle_timeout](#items_cloud_nat_allOf_i2_then_nat_groups_items_tcp_established_idle_timeout)
            - [1.8.5.1.2.1.7. [Optional] Property Networks > items > cloud_nat > allOf > Selected Primary Subnetworks and Selected Secondary Subnetworks > then > nat_groups > items > tcp_transitory_idle_timeout](#items_cloud_nat_allOf_i2_then_nat_groups_items_tcp_transitory_idle_timeout)
  - [1.9. [Optional] Property Networks > items > peers](#items_peers)
    - [1.9.1. Networks > items > peers > items](#items_peers_items)
      - [1.9.1.1. [Optional] Property Networks > items > peers > items > project](#items_peers_items_project)
      - [1.9.1.2. [Required] Property Networks > items > peers > items > network](#items_peers_items_network)
      - [1.9.1.3. [Optional] Property Networks > items > peers > items > export_custom_routes](#items_peers_items_export_custom_routes)
      - [1.9.1.4. [Optional] Property Networks > items > peers > items > import_custom_routes](#items_peers_items_import_custom_routes)
      - [1.9.1.5. [Optional] Property Networks > items > peers > items > import_subnet_routes_with_public_ip](#items_peers_items_import_subnet_routes_with_public_ip)
      - [1.9.1.6. [Optional] Property Networks > items > peers > items > export_subnet_routes_with_public_ip](#items_peers_items_export_subnet_routes_with_public_ip)
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2021-10-11 at 23:31:22 -0700